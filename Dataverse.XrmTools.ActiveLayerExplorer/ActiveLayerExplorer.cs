...
namespace Dataverse.XrmTools.ActiveLayerExplorer
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Active Layer Explorer"),
        ExportMetadata("Description", "Tool used to explore and remove active layers on managed solutions."),
    ...
    public class ActiveLayerExplorer : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new ActiveLayerExplorerControl();
        }

        /// <summary>
        /// Constructor 
        /// </summary>
        public ActiveLayerExplorer()
        {
