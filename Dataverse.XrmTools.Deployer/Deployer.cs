...
namespace Dataverse.XrmTools.Deployer
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Deployer"),
        ExportMetadata("Description", "Tool used to manage solution operations with ease. It allows for bulk export/import operations and ultimately a semi-automated deploy with just a few clicks."),
    ...
    public class Deployer : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new DeployerControl();
        }
